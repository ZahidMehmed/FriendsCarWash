  ...
  const pricingData = [
    {
      ...
      iconList:<> <BsCheck2Circle className='card-list-icons' /> <span>Soft-Cloth Wash</span></>,
      iconList1:<><BsCheck2Circle className='card-list-icons' /> <span>Soft-Free Rinse</span></>,
      iconList2:<><BsCheck2Circle className='card-list-icons' /> <span>Spot-Free Thermal dry</span></>
    },
    {
      ...
      iconList1:<><BsCheck2Circle className='card-list-icons' /> <span>Soft-Free Rinse</span></>,
      iconList2:<><BsCheck2Circle className='card-list-icons' /> <span>Spot-Free Thermal dry</span></>,
      iconList3:<><BsCheck2Circle className='card-list-icons' /> <span>Rain Sheild</span></>,
      iconList4:<><BsCheck2Circle className='card-list-icons' /> <span>Triple Foam</span></>
    },
    {
      ...
      iconList3:<><BsCheck2Circle className='card-list-icons' /> <span>Rain Sheild</span></>,
      iconList4:<><BsCheck2Circle className='card-list-icons' /> <span>Triple Foam</span></>,
      iconList5:<><BsCheck2Circle className='card-list-icons' /> <span>Tire-Dressing</span></>
    },
    {
      ...
      iconList4:<><BsCheck2Circle className='card-list-icons' /> <span>Triple Foam</span></>,
      iconList5:<><BsCheck2Circle className='card-list-icons' /> <span>Tire-Dressing</span></>,
      iconList6:<><BsCheck2Circle className='card-list-icons' /> <span>Vaccum and Wipe Console</span></>
    },
